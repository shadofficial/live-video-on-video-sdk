...
<div id="app">
  <div class="modal">
    ...
    <header>
      <h2>Create a Live Meeting</h2>
      <h3>Join over 5k participants</h3>

    </header>
    <div class="status">
      <!-- preserveAspectRatio here fixes the issue we were having with sizing via viewBox: https://css-tricks.com/scale-svg/ -->
      <span class="message" data-view="prompt"><b>Create a Live Meeting</b> i</span>
...
<label for="inp" class="inp">
  ...
  <input type="text" id="meetn" placeholder="Your Name">-->
    <footer class="buttons">
      <button class="button -accept" onclick="yahoo();">New Meeting</button>
    </footer>
  </div>
</div>
